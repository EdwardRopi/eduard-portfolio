...
const WORKS = [
  ...
  },
  {
    id: 'mindal',
    name: 'МИНДАЛЬ',
    field: 'Студия маникюра, Краснодар',
    kind: 'card',
    accent: '#C4557C',
    idea: 'Веер типсов перекрашивает весь сайт',
    desc: 'В шапке лежит веер типсов: выбираете оттенок — и в него перекрашивается вся страница. Клиент видит цвет не на крошечном кружке, а на большой площади, как на своих руках.',
    bullets: ['Цены на гель-лак, укрепление, педикюр и дизайн', 'Три мастера с портфолио работ', 'Запись на конкретное время, без «мы вам перезвоним»'],
    tags: ['HTML', 'CSS', 'JavaScript', 'CSS-переменные'],
  },
  {
    id: 'uklad',
    name: 'УКЛАД',
  ...
  },
  {
    id: 'proem',
    name: 'ПРОЁМ',
    field: 'Пластиковые окна с монтажом',
    kind: 'card',
    accent: '#3D6E9E',
    idea: 'Страница смотрит наружу сквозь оконный проём',
    desc: 'Первый экран — сам проём, сквозь который виден город; дальше видом управляет прокрутка. Дальше по-деловому: профили, этапы монтажа по ГОСТ, гарантия и расчёт по размерам.',
    bullets: ['Замер, изготовление, монтаж и уборка после работы', 'Калькулятор по размерам проёма', 'Гарантия 5 лет отдельным блоком'],
    tags: ['HTML', 'CSS', 'JavaScript', 'анимация'],
  },
  {
    id: 'pigment',
  ...
  },
  {
    id: 'karusel',
    name: 'Карусель',
    field: 'Студия организации праздников, Краснодар',
    kind: 'card',
    accent: '#C93A4D',
    idea: 'Афиша, собранная из фотографий шоу',
    desc: 'Редизайн сайта студии праздников: шесть страниц, портфолио программ, лофты, отзывы и заявка. Тёплая афишная палитра и крупные фотографии — здесь продаёт именно вид праздника.',
    bullets: ['Шесть страниц: услуги, портфолио, лофты, о компании, контакты, оферта', 'Форма заявки на Formspree и блок отзывов', 'Программы показаны фотографиями шоу, а не иконками'],
    tags: ['HTML', 'CSS', 'JavaScript', 'многостраничник'],
  },
];
